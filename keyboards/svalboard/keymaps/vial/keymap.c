...
const uint16_t PROGMEM keymaps[DYNAMIC_KEYMAP_LAYER_COUNT][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NORMAL] = LAYOUT(
        ...
        /*R2*/ KC_K              , KC_I              , KC_COLON          , KC_COMM         , KC_Y              , KC_NO             ,
        /*R3*/ KC_L              , KC_O              , LT(BOARD_CONFIG, KC_NO)  , KC_DOT   , KC_N              , KC_NO           ,
        /*R4*/ KC_SCLN           , KC_P              , KC_BSLS           , KC_SLSH         , KC_RBRC           , KC_NO          ,
        ...
        /*RT*/ LA_SYM            , QK_REP            , KC_NO             , KC_BSPC         , KC_LALT           , MO(_NUM)             ,
        /*LT*/ LA_NAV            , KC_SPACE          , KC_NO             , LGUI_T(KC_TAB)  , KC_LCTL           , KC_CAPS       
        ),

    [_SYM] = LAYOUT(
        /*     Center            North               East               South             West              Double*/
        /*R1*/ KC_LEFT           , LSFT(KC_7)        , LSFT(KC_6)       , KC_LEFT         , KC_6            , KC_NO           ,
        /*R2*/ KC_DOWN           , LSFT(KC_8)        , KC_NO            , KC_UP           , LSFT(KC_MINUS)  , KC_NO           ,
        /*R3*/ KC_UP             , LSFT(KC_9)        , KC_NO            , KC_DOWN         , KC_INSERT       , KC_NO           ,
        /*R4*/ KC_RGHT           , LSFT(KC_0)        , KC_NO            , KC_RIGHT        , LSFT(KC_GRAVE)  , KC_NO           ,
        /*L1*/ OS_SHFT           , LSFT(KC_4)        , KC_5             , KC_END          , LSFT(KC_5)      , KC_NO           ,
        /*L2*/ OS_CTRL           , LSFT(KC_3)        , KC_MINUS         , KC_PGDN         , LSFT(KC_EQUAL)  , KC_NO           ,
        /*L3*/ OS_ALT            , LSFT(KC_2)        , KC_DOT           , KC_PGUP         , KC_TRNS         , KC_NO           ,
        /*L4*/ OS_CMD            , LSFT(KC_1)        , KC_EQUAL         , KC_HOME         , KC_TRNS         , KC_NO           ,
        /*Down             Pad             Up              Nail            Knuckle         DoubleDown*/
